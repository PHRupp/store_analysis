...
python load_db.py \
    --customers="$DATA_DIR/CC-Customers_2022-12-08-2026-05-25.csv" \
    --orders="$DATA_DIR/CC-Orders-08122022-25052026.csv" \
    --old_pos_orders="$DATA_DIR/HC_OldPOS_Orders_final.csv" \
    --items="$DATA_DIR/CC-Items-Sales_2022-12-08-2026-05-25.csv" \
