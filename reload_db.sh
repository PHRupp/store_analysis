...
python load_db.py \
    --customers="$DATA_DIR/CC-Customers_2022-12-08-2026-06-26.csv" \
    --orders="$DATA_DIR/CC-Orders-08122022-26062026.csv" \
    --old_pos_orders="$DATA_DIR/HC_OldPOS_Orders_final.csv" \
    --items="$DATA_DIR/CC-Items-Sales_2022-12-08-2026-06-26.csv" \
